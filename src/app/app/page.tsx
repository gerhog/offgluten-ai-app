...
export default async function AppPage() {
  ...
  return (
    <main style={{ maxWidth: 600, margin: "80px auto", padding: "0 24px" }}>
      <h1 style={{ fontSize: 22, fontWeight: 700, marginBottom: 24 }}>Offgluten AI — App</h1>

      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14, marginBottom: 32 }}>
        <tbody>
          <tr>
            <td style={{ padding: "8px 0", color: "#555", width: 180 }}>User ID</td>
          ...
          <tr>
            <td style={{ padding: "8px 0", color: "#555" }}>Entitlement</td>
            <td><span style={badge}>{entitlement}</span></td>
          </tr>
          <tr>
            <td style={{ padding: "8px 0", color: "#555" }}>Profile loaded</td>
            <td>{profile ? "yes" : "no (profiles row missing)"}</td>
          </tr>
        </tbody>
      </table>
